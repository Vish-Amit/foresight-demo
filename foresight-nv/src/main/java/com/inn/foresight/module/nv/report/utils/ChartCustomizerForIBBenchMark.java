...
public class ChartCustomizerForIBBenchMark implements JRChartCustomizer {

	private Logger logger = LogManager.getLogger(ChartCustomizerForIBBenchMark.class);
	...
	//br.setMaximumBarWidth(0.10);
			...
			if (cd != null) {
				...
				for (String s1 : stringlist) {
					if (s1.equalsIgnoreCase(Symbol.EMPTY_STRING)||s1.isEmpty()||s1.length()==0) {
						...
						//br.setBasePositiveItemLabelPosition(new ItemLabelPosition(ItemLabelAnchor.INSIDE5, TextAnchor.CENTER_RIGHT, TextAnchor.BOTTOM_CENTER, 90.0));
