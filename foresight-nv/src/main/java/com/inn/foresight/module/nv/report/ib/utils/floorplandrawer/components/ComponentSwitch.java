...
public class ComponentSwitch implements Component {
	private Logger logger = LogManager.getLogger(ComponentSwitch.class);

	BufferedImage img;
	PointF centerPoint;


	public ComponentSwitch(PointF pointF) {
	...
	public void initializeImage() {
		 try {
			 String path =ConfigUtils.getString(NVConfigUtil.INBUILDING_COMPONENT_IMAGE_PATH);
				img = ImageIO.read(new File(path+DrawFloorConstant.ROUTER_ICON));
			} catch (IOException e) {
