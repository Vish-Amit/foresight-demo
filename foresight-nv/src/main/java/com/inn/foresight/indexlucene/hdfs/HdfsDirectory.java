...
public class HdfsDirectory extends BaseDirectory {
	  ...
	  public HdfsDirectory(Path hdfsDirPath, FileSystem fileSystem) throws IOException {
	    this(hdfsDirPath, HdfsLockFactory.INSTANCE, fileSystem, DEFAULT_BUFFER_SIZE);
	  }

	  public HdfsDirectory(Path hdfsDirPath, LockFactory lockFactory, FileSystem fileSystem, int bufferSize)
	      throws IOException {
	    super(lockFactory);
	    this.hdfsDirPath = hdfsDirPath;
	    this.fileSystem = fileSystem;
	    this.bufferSize = bufferSize;
	    System.out.println("hdfsDirPath.toUri()--"+hdfsDirPath.toUri());
	    fileContext = FileContext.getFileContext(hdfsDirPath.toUri(), fileSystem.getConf());
